...
Notice by default this call returns the age interval between lower and upper quantile bounds of 0.25 and 0.75, but we could modify these bounds if desired, see `?LifeIneq::ineq_iqr`. 
