...
#' @param method one of \code{c("variance","sd","iqr","AID","Gini","MLD","edag","Cp","Theil")}
#' @param ... other optional arguments used by particular methods.
#'
#' @export

ineq <- function(age, dx, lx, ex, ax, method = c("variance","sd","iqr","AID","Gini","MLD","edag","Cp","Theil"),...){
